...
{
    public class BusinessStateService : ServiceBase<BusinessState>, IBusinessStateService
    {
        public BusinessStateService(IRepositoryBase<BusinessState> repository) : base(repository)
        {
        }
    }
}
